...
<body>
    ...
    <div class="container">
        ...
        <div class="products">
            <h2>Pants and Jeans Products</h2>
            ...
            <div class="product-grid">
                ...
                // Query to fetch products from the 'product' table based on category 'Pants' and sorting
                $sql = "SELECT * FROM product WHERE productCategory = 'Pants' AND (productName LIKE ? OR productDesc LIKE ?) $sort_order";

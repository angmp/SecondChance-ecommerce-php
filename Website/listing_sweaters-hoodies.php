...
<body>
    ...
    <div class="container">
        ...
        <div class="products">
            <h2>Sweaters & Hoodies Products</h2>
            ...
            <div class="product-grid">
                ...
                // Query to fetch products from the 'product' table based on category 'Sweaters & Hoodies' and sorting
                $sql = "SELECT * FROM product WHERE productCategory = 'Sweaters & Hoodies' AND (productName LIKE ? OR productDesc LIKE ?) $sort_order";
